...
const LogMiddleWare = (req, res, next) => {
    console.log(color["blueBG"][0], "Message come in！！！")
    console.log(color["blueBG"][0], "router: " + req.url)
    console.log(color["blueBG"][0], "method: " + req.method)
    console.log(color["blueBG"][0], `query: ${JSON.stringify(req.query)}`)
    console.log(color["blueBG"][0], `body: ${JSON.stringify(req.body)}`)
    next()
}
